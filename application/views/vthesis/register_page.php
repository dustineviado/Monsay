					...
					<form>
						...
						<div class="row form-group">
							<div class="col-md-5">
								...
								<input id="birthdate" type="date" min="2017-10-15" class="form-control">
							</div>
							<div class="col-md">
								<label for="age" class="col-form-label">Age</label>
								<input id="age" type="number" min="1" max="100" class="form-control" placeholder="Age">
							</div>
							<div class="col-md">
						...
						<div class="row form-group">
							<div class="col-md">
								...
								<input id="mlastname" type="text" class="form-control" placeholder="Last name">
							</div>
							<div class="col-md">
								<label for="mfirstname" class="col-form-label">&nbsp;</label>
								<small id="fillhelp" class="form-text text-muted">&nbsp;</small>
								<input id="mfirstname" type="text" class="form-control" placeholder="First name">
							</div>
							<div class="col-md">
								<label for="mmiddlename" class="col-form-label">&nbsp;</label>
								<small id="fillhelp" class="form-text text-muted">&nbsp;</small>
								<input id="mmaiddlename" type="text" class="form-control" placeholder="Middle name">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md">
								...
								<input id="flastname" type="text" class="form-control" placeholder="Last name">
							</div>
							<div class="col-md">
								<label for="ffirstname" class="col-form-label">&nbsp;</label>
								<small id="fillhelp" class="form-text text-muted">&nbsp;</small>
								<input id="ffirstname" type="text" class="form-control" placeholder="First name">
							</div>
							<div class="col-md">
								<label for="fmiddlename" class="col-form-label">&nbsp;</label>
								<small id="fillhelp" class="form-text text-muted">&nbsp;</small>
								<input id="fmaiddlename" type="text" class="form-control" placeholder="Middle name">
							</div>
						</div>
						...
						<div class="row form-group">
							...
							<div class="col-md">
								<label for="gfirstname" class="col-form-label">&nbsp;</label>
								<small id="fillhelp" class="form-text text-muted">&nbsp;</small>
								<input id="gfirstname" type="text" class="form-control" placeholder="First name">
							</div>
							<div class="col-md">
								<label for="gmiddlename" class="col-form-label">&nbsp;</label>
								<small id="fillhelp" class="form-text text-muted">&nbsp;</small>
								<input id="gmaiddlename" type="text" class="form-control" placeholder="Middle name">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md">
								...
								<input id="pgcontact" type="tel" class="form-control" placeholder="Contact">
							</div>
						</div>
