							...
							$(document).ready(function(){
								...
								$('#addmodalbtn').click(function(){  
							      ...
							      var dataTable = $('#lamesa234').dataTable({  
							           ...
							           "order":[],  
							           "ajax":{  
							                url:"<?php echo base_url() . 'subject_controller2/fetch_user'; ?>",  
							                type:"POST"  
							           },  
							           "columnDefs":[  
							                {  
							      ...
							      $(document).on('click', '#action', function(event){  
							           ...
							           {  
							                $.ajax({  
							                	type:"POST",
							                     url:"<?php echo base_url() . 'subject_controller2/subjectaction'; ?>",  
							                     data:{
							                     	id:subjid,
							                     	name:subjname,
							                     	fac:subjfac,
							      ...
							      $(document).on('click','.edit', function(){  
							           ...
							           $.ajax({  
							                url:"<?php echo base_url() . 'subject_controller2/fetch_single_user'; ?>",  
							                method:"POST",  
							                data:{sid:sid},  
							                dataType:"json",  
							                success:function(data)  
							      ...
							      $(document).on('click', '.delete', function(){  
							           ...
							           {  
							                $.ajax({  
							                     url:"<?php echo base_url(); ?>subject_controller2/deletesubject",  
							                     method:"POST",  
							                     data:{sid:sid},  
							                     success:function(data)  
							                     {  
