...
<div id="mySidenav" class="sidenav text-muted">
  ...
  <b><p style="font-family: 'helvetica';font-size: 20px; margin-left: 60px;">Student  </p></b>
  ...
  <a href="grading_controller" style="font-family:  'helvetica'; font-weight: bold; font-size: 20px;"><i class="fa fa-star">&nbsp;&nbsp;Grades</a></i>
